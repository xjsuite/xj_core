...
<s:layout-definition>
    ...
    <html>
        <head>
            ...
            <link href="xj.core/layout/assets/css/font-roboto.css" rel='stylesheet' type='text/css' />
            ...
            <link href="xj.core/layout/adminlte-2.3.3/css/AdminLTE.css" rel="stylesheet" type='text/css' />
            <link href="xj.core/layout/adminlte-2.3.3/css/skins/_all-skins.min.css" rel="stylesheet" type='text/css' />
            <link href="xj.core/layout/assets/css/select2-bootstrap.css" rel="stylesheet" type='text/css' />
            <link href="xj.core/layout/assets/css/sweetalert.css" rel="stylesheet" type='text/css' />
            <link href="xj.core/layout/assets/css/datepicker3.css" rel="stylesheet" type='text/css' />
            <link href="xj.core/layout/assets/css/daterangepicker-bs3.css" rel="stylesheet" type='text/css' />            
        ...
        <body class="hold-transition skin-purple sidebar-mini">
            <div class="wrapper">
                ...
                <aside class="main-sidebar">
                    ...
                    <section class="sidebar">
                        ...
                        <div class="user-panel">
                            <s:layout-component name="xj-userpanel">

                            </s:layout-component>
                            <s:layout-component name="xj-sidebar">

                            </s:layout-component>  
                            <s:layout-component name="xj-labels">
                ...
                <script src="xj.core/layout/assets/js/jquery-impromptu.js"></script>
                ...
                <script src="xj.core/layout/assets/js/daterangepicker.js"></script>
                <script src="xj.core/layout/assets/js/bootstrap-datepicker.js"></script>
                <script src="xj.core/layout/adminlte-2.3.3/js/app.js"></script>
