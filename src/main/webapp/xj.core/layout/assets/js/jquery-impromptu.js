    ...
    Imp.prototype = {
        ...
        open: function (message, options) {
            ...
            msgbox += '<div class="' + opts.prefix + ' ' + opts.classes.prompt + '">' +
                    '<div class="xjheader"><h4 id="xj-title" class="xjheadertitle">Confirmation</h4></div>' +
        ...
        addState: function (statename, stateobj, afterState) {
            ...
            for (i = 0, l = buttons.length; i < l; i++) {
                ...
                var extclass = "btn btn-success";
                if (defbtn === "") {
                    extclass = "btn btn-warning";
                }

                state += '<button class="' + extclass + " " + opts.classes.button + ' ' + opts.prefix + 'button ' + defbtn;
