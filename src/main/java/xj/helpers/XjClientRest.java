...
public class XjClientRest {
    ...
    // getter and setter
    public XjClientRest setRestUrl(String restUrl) {
        this.restUrl = restUrl;
        return this;
    }

    public XjClientRest setParams(String[] params) {
        this.params = params;
        return this;
    }

    public XjClientRest setParamsValue(String[] paramsValue) {
        this.paramsValue = paramsValue;
        return this;
    }

    public XjClientRest setHeaders(String[] headers) {
        this.headers = headers;
        return this;
    }

    public XjClientRest setHeadersValue(String[] headersValue) {
